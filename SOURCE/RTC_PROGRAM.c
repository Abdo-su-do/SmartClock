...
#include "../HAL/RTC/RTC_PRIVATE.h"
#include "../HAL/RTC/RTC_CFG.h"
...
void HRTC_voidInit(void)
{
    ...
    if (RTC_u8ReadRegister(DS3231_CONTROL_REG, &Local_u8ControlRegister) == 0) { return; }
    /*
     * EOSC = 0:
     * Start the DS3231 oscillator.
     */
    CLR_BIT(Local_u8ControlRegister,DS3231_CONTROL_EOSC_BIT);
     ...
     */
    SET_BIT(Local_u8ControlRegister,DS3231_CONTROL_INTCN_BIT);
    CLR_BIT(Local_u8ControlRegister, DS3231_CONTROL_RS1_BIT);
    CLR_BIT(Local_u8ControlRegister, DS3231_CONTROL_RS2_BIT);
#elif RTC_SQUARE_WAVE_MODE == RTC_SQUARE_WAVE_1HZ
    CLR_BIT(Local_u8ControlRegister,DS3231_CONTROL_INTCN_BIT);
    CLR_BIT(Local_u8ControlRegister, DS3231_CONTROL_RS1_BIT);
    CLR_BIT(Local_u8ControlRegister, DS3231_CONTROL_RS2_BIT);
#elif RTC_SQUARE_WAVE_MODE == RTC_SQUARE_WAVE_1024HZ
    CLR_BIT(Local_u8ControlRegister,DS3231_CONTROL_INTCN_BIT);
    SET_BIT(Local_u8ControlRegister,DS3231_CONTROL_RS1_BIT);
    CLR_BIT(Local_u8ControlRegister,DS3231_CONTROL_RS2_BIT);
#elif RTC_SQUARE_WAVE_MODE == RTC_SQUARE_WAVE_4096HZ
    CLR_BIT(Local_u8ControlRegister,DS3231_CONTROL_INTCN_BIT);
    CLR_BIT(Local_u8ControlRegister,DS3231_CONTROL_RS1_BIT);
    SET_BIT(Local_u8ControlRegister,DS3231_CONTROL_RS2_BIT);
...
#error "Invalid RTC_SQUARE_WAVE_MODE configuration"
    ...
    RTC_u8WriteRegister(DS3231_CONTROL_REG,Local_u8ControlRegister);
}
...
void HRTC_voidSetTime(u8 A_u8Hours, u8 A_u8Minutes,  u8 A_u8Seconds,  RTC_CLOCK_MODE A_enuClockMode, RTC_PERIOD A_enuPeriod)
{
    ...
    RTC_u8WriteRegisters(DS3231_SECONDS_REG,Local_au8TimeData,3);
}
...
void HRTC_voidGetTime(RTC_DATE_TIME *A_pstrDateTime)
{
    ...
    { return; }
    if (RTC_u8ReadRegisters(DS3231_SECONDS_REG, Local_au8TimeData, 3) == 0)
    {return; }
...
void HRTC_voidSetDate(RTC_DAY A_enuDay,u8 A_u8Date,u8 A_u8Month,u16 A_u16Year){
     ...
     */
    CLR_BIT(Local_au8DateData[2], DS3231_CENTURY_BIT);
    Local_au8DateData[3] = RTC_u8DecimalToBCD((u8)(A_u16Year - 2000));
    RTC_u8WriteRegisters(DS3231_DAY_REG,Local_au8DateData,4);
}
...
void HRTC_voidGetDate(RTC_DATE_TIME *A_pstrDateTime){
    ...
    if (A_pstrDateTime == NULL)
    { return; }
    if (RTC_u8ReadRegisters(DS3231_DAY_REG, Local_au8DateData,4) == 0)
    {return; }
...
void HRTC_voidSetDateTime(const RTC_DATE_TIME *A_pstrDateTime)
{
    ...
    CLR_BIT(Local_au8DateTimeData[5], DS3231_CENTURY_BIT);
    Local_au8DateTimeData[6] = RTC_u8DecimalToBCD((u8)(A_pstrDateTime->Year - 2000));
    RTC_u8WriteRegisters(DS3231_SECONDS_REG, Local_au8DateTimeData,7);
}
...
void HRTC_voidGetDateTime(RTC_DATE_TIME *A_pstrDateTime)
{
    ...
    if (A_pstrDateTime == NULL)
    { return; }
    if (RTC_u8ReadRegisters(DS3231_SECONDS_REG,Local_au8DateTimeData,7) == 0)
    { return; }
    ...
    const RTC_ALARM1_CONFIG *A_pstrAlarmConfig)
{
    ...
    RTC_u8WriteRegisters(DS3231_ALARM1_SECONDS_REG,
                         Local_au8AlarmData,
                         4);
    ...
    RTC_ALARM1_CONFIG *A_pstrAlarmConfig)
{
    ...
    if (RTC_u8ReadRegisters(DS3231_ALARM1_SECONDS_REG,
                            Local_au8AlarmData,
                            4) == 0)
    {
        return;
    ...
    const RTC_ALARM2_CONFIG *A_pstrAlarmConfig)
{
    ...
    RTC_u8WriteRegisters(DS3231_ALARM2_MINUTES_REG,
                         Local_au8AlarmData,
                         3);
    ...
    RTC_ALARM2_CONFIG *A_pstrAlarmConfig)
{
    ...
    if (RTC_u8ReadRegisters(DS3231_ALARM2_MINUTES_REG,
                            Local_au8AlarmData,
                            3) == 0)
    {
        return;
                            ...
                            RTC_ALARM_STATE A_enuState)
{
    ...
    if (RTC_u8ReadRegister(DS3231_CONTROL_REG,
    ...
    if (A_enuState == RTC_ALARM_ENABLED)
    {
        ...
        SET_BIT(Local_u8ControlRegister,
                DS3231_CONTROL_INTCN_BIT);

        if (A_enuAlarm == RTC_ALARM_1)
        {
            SET_BIT(Local_u8ControlRegister,
                    DS3231_CONTROL_A1IE_BIT);
        }
        else
        {
            SET_BIT(Local_u8ControlRegister,
                    DS3231_CONTROL_A2IE_BIT);
        }
    }
    else
    {
    ...
    RTC_u8WriteRegister(DS3231_CONTROL_REG,
...
u8 HRTC_u8IsAlarmTriggered(RTC_ALARM A_enuAlarm)
{
    ...
    if (RTC_u8ReadRegister(DS3231_STATUS_REG,
    ...
    if (A_enuAlarm == RTC_ALARM_1)
    {
        return GET_BIT(Local_u8StatusRegister,
                       DS3231_STATUS_A1F_BIT);
    }
    else if (A_enuAlarm == RTC_ALARM_2)
    {
        return GET_BIT(Local_u8StatusRegister,
                       DS3231_STATUS_A2F_BIT);
    }
...
void HRTC_voidClearAlarmFlag(RTC_ALARM A_enuAlarm)
{
    ...
    RTC_u8WriteRegister(DS3231_STATUS_REG,
